...
declare class Tool extends _HeyApiClient {
    ...
    execute<ThrowOnError extends boolean = false>(options?: Options<ToolExecuteData, ThrowOnError>): import("./client/types.gen.js").RequestResult<ToolExecuteResponses, ToolExecuteErrors, ThrowOnError, "fields">;
}
