...
export declare class Tool extends HeyApiClient {
     ...
     */
    execute<ThrowOnError extends boolean = false>(parameters?: {
        directory?: string;
        sessionID?: string;
        messageID?: string;
        providerID?: string;
        ...
        agent?: string;
        callID?: string;
    }, options?: Options<never, ThrowOnError>): import("./client/types.gen.js").RequestResult<ToolExecuteResponses, ToolExecuteErrors, ThrowOnError, "fields">;
}
